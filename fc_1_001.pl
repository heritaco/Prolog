...
% Caso base: si solo hay dos canibales, simplemente los subimos al bote de izquierda a derecha.
move([2,0,r,1,3]):- 
    write('Mover 2 canibales de'),  % Imprimir el inicio del mensaje de movimiento
    write(Start),  % Imprimir de izquierda
    write(' a '),  % Imprimir el medio del mensaje de movimiento
    write(End),  % Imprimir a derecha
    nl.  % Imprimir un carácter de nueva línea

% Caso recursivo: empieza el problema de los canibales y misioneros
% CL cannibal left, ML misionero left, _ bote, CR cannibal right, MR misionero right
move(CL,ML , _, CR, MR):- 
...
% El predicado main resuelve el problema de los canibales y misioneros para 3 canibales y 3 misioneros.
main:- move(3, 3, left, 0, 0).
