...
move((CL,ML,left,CR,MR),(CL2,ML2,right,CR2,MR2)):- % Two missionaries cross from the right bank to the left bank.
    CL2 is CL, % Cannibals on state 2 is equal to cannibals on state 1
...
move((CL,ML,left,CR,MR),(CL2,ML2,right,CR2,MR2)):- % Two cannibals cross from the right bank to the left bank.
...
move((CL,ML,left,CR,MR),(CL2,ML2,right,CR2,MR2)):- % One missionary and one cannibal cross from the right bank to the left bank.
...
move((CL,ML,left,CR,MR),(CL2,ML2,right,CR2,MR2)):- % One missionary crosses from the right bank to the left bank.
    CL2 is CL, % Cannibals on state 2 is equal to cannibals on state 1
    ML2 is ML+1, % Increase the number of missionaries on the left bank by 1
...
move((CL,ML,left,CR,MR),(CL2,ML2,right,CR2,MR2)):- % One cannibal crosses from the right bank to the left bank.
    CL2 is CL+1, % Increase the number of cannibals on the left bank by 1
    ML2 is ML, % Missioners on state 2 is equal to missionaries on state 1
    CR2 is CR-1, % Decrease the number of cannibals on the right bank by 1
    MR2 is MR, % Missioners on state 2 is equal to missionaries on state 1
